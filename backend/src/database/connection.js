...
const connectDB = async () => {
  try {
    ...
    console.log('Real MongoDB not available, starting in-memory MongoDB for testing...');

    try {
      // Dynamically import MongoMemoryServer only when needed (it's a devDependency)
